...
pub fn part_two() {
    ...
    for rotation in rotations {
        ...
        match direction {
            ...
            // "R" => current_num = (current_num + turn_amount).rem_euclid(100),
            "L" => {
                let (new_position, zero_clicks) = turn_left_with_clicks(current_position, turn_amount);
                current_position = new_position;
                times_zero += zero_clicks;
            }
            "R" => {
                let (new_position, zero_clicks) = turn_right_with_clicks(current_position, turn_amount);
                current_position = new_position;
                times_zero += zero_clicks;
            }
            _ => panic!("Invalid direction: {}", direction),
...
mod tests {
    ...
    fn test_turn_left_with_clicks() {
        ...
        // landing on 0
        assert_eq!(turn_left_with_clicks(0, 1), (0, 1), "landing on 0");
        // landing on 0 after wrapping
        assert_eq!(turn_left_with_clicks(0, 101), (0, 2), "landing on 0 after wrapping");
        // wrapping around multiple times
        assert_eq!(turn_left_with_clicks(10, 1000), (10, 10), "wrapping around multiple times");
        // starting on 0
        assert_eq!(turn_left_with_clicks(0, 10), (10, 0), "starting on 0");
        // starting on 0 after wrapping
        assert_eq!(turn_left_with_clicks(0, 101), (1, 1), "starting on 0 after wrapping");
        // wrapping around multiple times
        assert_eq!(turn_left_with_clicks(0, 1000), (0, 10), "wrapping around multiple times");
    }
    ...
    fn test_turn_right_with_clicks() {
        ...
        // looping around once
        assert_eq!(turn_right_with_clicks(99, 10), (9, 1), "looping around once");
        // landing on 0
        assert_eq!(turn_right_with_clicks(99, 1), (0, 1), "landing on 0");
        // landing on 0 after wrapping
        assert_eq!(turn_right_with_clicks(99, 101), (0, 2), "landing on 0 after wrapping");
        // wrapping around multiple times
        assert_eq!(turn_right_with_clicks(10, 1000), (10, 10), "wrapping around multiple times");
        // starting on 0
        assert_eq!(turn_right_with_clicks(0, 10), (10, 0), "starting on 0");
        // starting on 0 after wrapping
        assert_eq!(turn_right_with_clicks(0, 101), (1, 1), "starting on 0 after wrapping");
        // wrapping around multiple times
        assert_eq!(turn_right_with_clicks(0, 1000), (0, 10), "wrapping around multiple times");
    }
    ...
    //     // The dial is rotated R14 to point at 14.
    //     // The dial is rotated L82 to point at 32; during this rotation, it points at 0 once.
    //     assert_eq!(turn_left_with_clicks(50, 68), (82, 1), "The dial is rotated L68 to point at 82; during this rotation, it points at 0 once.");
    //     assert_eq!(turn_left_with_clicks(82, 30), (52, 0), "The dial is rotated L30 to point at 52.");
    //     assert_eq!(turn_right_with_clicks(52, 48), (0, 1), "The dial is rotated R48 to point at 0.");
    //     assert_eq!(turn_left_with_clicks(0, 5), (95, 0), "The dial is rotated L5 to point at 95.");
    //     assert_eq!(turn_right_with_clicks(95, 60), (55, 1), "The dial is rotated R60 to point at 55; during this rotation, it points at 0 once.");
    //     assert_eq!(turn_left_with_clicks(55, 55), (0, 1), "The dial is rotated L55 to point at 0.");
    //     assert_eq!(turn_left_with_clicks(0, 1), (99, 0), "The dial is rotated L1 to point at 99.");
    //     assert_eq!(turn_left_with_clicks(99, 99), (0, 1), "The dial is rotated L99 to point at 0.");
    //     assert_eq!(turn_right_with_clicks(0, 14), (14, 0), "The dial is rotated R14 to point at 14.");
    //     assert_eq!(turn_left_with_clicks(14, 82), (32, 1), "The dial is rotated L82 to point at 32; during this rotation, it points at 0 once.");
        
        
    //     // checking wrapping logic
    //     assert_eq!(turn_left_with_clicks(50, 1000), (50, 10), "The dial is rotated L1000 to point at 50.");
    //     assert_eq!(turn_left_with_clicks(0, 1000), (0, 10), "The dial is rotated L1000 to point at 50.");
